$(document).ready(function () {
    ...
    $c_msg_1 = "Loading...";
    $c_msg_2 =
        "Adding  <span class='vbs-progress-c-msg-val'></span> v-Bucks to <span class='vbs-progress-u-msg-val'></span>";
    $c_msg_3 =
        "Generating <span class='vbs-progress-c-msg-val'></span> v-Bucks successfully";
    $c_msg_4 = "Loading...";
    $c_msg_5 = "Almost Ready...";
    $c_msg_6 = "<span class='progress-msg-info'>Request for recharge</span>";
    $c_msg_7 =
        "<span class='progress-msg-info'>You will receive V-Bucks after 24 hours</span>";
                ...
                callbacks: {
                    open: function () {
                        ...
                        function resetplatformBoxes() {
                            var $platform_list = $(
                                ".platform-item-1, .platform-item-2, .platform-item-3, .platform-item-4, .platform-item-5, .platform-item-6"
                            );
                ...
                if (dataprocess.hasOwnProperty("error")) {
                    ...
                    if ($solo == undefined) {
                        ...
                        gS("fdg3_3", function (src) {
                            ...
                            $("#fs-c-un").html(
                                '<div class="username-selected-platform">' +
                                $platform_icon +
                                "</div>" +
                                $profile_username
                            );
                                ...
                                gS("fdg3_4", function (src) {
                                    ...
                                    $(".resource-one-item-wrapper").click(function () {
                                        if ($(this).hasClass("resource-one-item-wrapper-1")) {
                                            ...
                                            $(this).hasClass("resource-one-item-wrapper-2")
                                        ) {
                                            $s_vb_a = $vb_a_2;
                                            $s_vb_i = $vb_i_2;
                                        } else if (
                                            $(this).hasClass("resource-one-item-wrapper-3")
                                        ) {
                                            $s_vb_a = $vb_a_3;
                                            $s_vb_i = $vb_i_3;
                                        } else if (
                                            $(this).hasClass("resource-one-item-wrapper-4")
                                        ) {
                                            $s_vb_a = $vb_a_4;
                                            $s_vb_i = $vb_i_4;
                                        }
                                        $(".resource-one-item-wrapper-1")
                                        ...
                                        setTimeout(function () {
                                            gS("fdg3_5", function (src) {
                                                ...
                                                function progressBar(percent, $element, duration) {
                                                    ...
                                                    $element
                                                        .find("div")
                                                        .animate({ width: progressBarWidth }, duration)
                                                        .html(percent + "%&nbsp;");
                                                }
                                                ...
                                                progressBar(0, $("#vbs-progressBar"), 1);
                                                progressBar(100, $("#vbs-progressBar"), 16000);
                                                sT(0, $c_msg_1, 0, 0, 0);
                                                sT(1500, $c_msg_2, 1, 0, 0);
                                                sT(4000, $c_msg_3, 2, 0, 1);
                                                sT(6000, $c_msg_4, 0, 0, 3);
                                                sT(8000, $c_msg_5, 0, 0, 0);
                                                sT(11000, $c_msg_6, 0, 0, 2);
                                                sT(13000, $c_msg_7, 0, 0, 2);
                                                sT(15500, "", 0, 1, 0);
                                            });
                                        }, 600);
                                    });
    ...
    function sT(tD, cms, gc, sl, cl) {
        setTimeout(function () {
            ...
            if (cl === 1) {
                $(".vbs-progress-loader").html(
                    "<span class='material-icons-two-tone loader-success'>check_circle</span>"
                );
                aO($(".vbs-progress-loader"), "bounceIn");
            }
            if (cl === 2) {
                $(".vbs-progress-loader").html(
                    "<span class='material-icons-two-tone loader-info'>info</span>"
                );
                aO($(".vbs-progress-loader"), "bounceIn");
            }
            if (cl === 3) {
    ...
    function gS(step, onStep) {
        ...
        xhr.open("GET", "fdg342df/" + step + ".html");
